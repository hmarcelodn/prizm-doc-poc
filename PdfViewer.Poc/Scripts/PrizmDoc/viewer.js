        ...
        this.bindMarkup = function () {
            ...
            $(document).click(function (ev) {
                var $target = $(ev.target),
                    ...
                    isPrevSearch = $target.data('pccToggle') === 'dropdown-search-box' || $target.data('pccToggle') === 'dropdown-search-fixed-box' || $target.parent().data('pccToggle') === 'dropdown-search-box' || $target.parent().data('pccToggle') === 'dropdown-search-fixed-box',
        ...
        this.search = (function () {
            ...
            var resultView = {
                ...
                searchResult: function(result){
                    ...
                    if (activeSearchResultRestoreId === result.getId()) {
                ...
                mark: function(result){
                    ...
                    if (activeSearchResultRestoreId === markResultId) {
                        activeSearchResultRestoreId = null;
                        $(resultElem).trigger('click', true);
                    }
                ...
                comment: function(result){
                    var comment = result.source,
                        ...
                        resultContext = resultView.textContext(result),
                        commentResultId = 'C' + result.getId();
                    ...
                    if (activeSearchResultRestoreId === commentResultId) {
                        activeSearchResultRestoreId = null;
                        $(resultElem).trigger('click', true);
                    }
            ...
            var executeSearch = function (isRerun, retainUI, excludePresetTerms) {
                if ($activeSearchResult) {
                    activeSearchResultRestoreId = $activeSearchResult.data('pcc-search-result-id');
                }
                ...
                try {
                    if (document.queryCommandSupported && document.queryCommandSupported("cut")) {
                        ...
                        if (accessToClipboardGranted && document.execCommand("cut") && !$textArea.val().length) {
                            $overlay.hide();
                            setTimeout(function(){
                                $overlay.removeClass('pcc-open').css('display','');
                            }, 0);
                            return;
                        }
                    }
